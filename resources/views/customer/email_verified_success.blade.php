                                    ...
                                    <img src="{{url('/')}}/images/checkmark.gif" alt="success" width="130" class="mx-auto">
                                        ...
                                        <div class="otherMsgDetail">
                                            ...
                                            <div class="otherSubDetail">
                                                <h3 class="text-center"><b>Your email has been verified successfully!</b></h3>
                                                <p class="mt-5 text-center">You can now login to the element3 application.</p>
                                            <p class="mt-5 text-center desktophide"><a href="{{url('/d/customer/email-verify-success')}}" class="button">Continue to App </a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!-- <h1 style="color:green">Successfully Email Verified</h1> -->