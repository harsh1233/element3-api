            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td width="50%" class="top-right-panel" style="text-align: right;">
                  ...
                  <p><b>Quote Offer Number:</b> # <?php echo $estimate['estimate_number'];?></p>
                  <p><b>Quote Offer Date:</b> <?php echo date('d.m.Y',strtotime($estimate['estimate_date'])); ?></p>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td width="60%" class="logo top-right-panel" style="text-align: left;">
                  ...
                  <p><b>Customer Name:</b> <?php echo $estimate['customer_name'];?></p>
                  <p><b>Start Date</b>:</b> <?php echo date('d.m.Y',strtotime($estimate['start_date']));?></p>
                  <p><b>Start Time</b>:</b> <?php echo date('h:i a',strtotime($estimate['start_time']));?></p>
                  <p><b>End Date</b>:</b> <?php echo date('d.m.Y',strtotime($estimate['end_date']));?></p>
                  <p><b>End Time</b>:</b> <?php echo date('h:i a',strtotime($estimate['end_time']));?></p>
                  </div>
                  <div class="invoice__company-contact">
                    <p><b>Email:</b><span class="ml-2"><?php echo $estimate['customer_email'];?></span></p>
                    <p><b>Mobile:</b></n><span class="ml-2"><?php echo $estimate['customer_mobile'];?></span></p>
                </td>
                <td width="50%" class="top-right-panel" style="text-align: right;">
          ...
          <td valign="top" class="bg_white" style="">
            <table class="payment-table">
              ...
              <tr>
                ...
                <td><?php echo $estimate['course_name']; ?></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Total Course Price:</p></th>
                <td> <span >&euro; <?php echo $estimate['total_price']; ?></span></td>
              </tr>
             <tr>
                <th><p class="semibold-text">Discount(%)</p></th>
                    <td><?php if($estimate['discount']) { ?><span> <?php echo $estimate['discount']; ?> </span> <?php } else { echo "0"; } ?></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Excluding VAT Amount</p></th>
                <td><span>&euro; <?php echo $estimate['vat_excluded_amount']; ?></span></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Vat Amount (<?php echo $estimate['vat_percentage']; ?>%)</p></th>
                <td><span>&euro; <?php echo $estimate['vat_amount']; ?></span></td>
              </tr>

              @if($estimate['is_include_lunch'])
              <tr>
                <th><p class="semibold-text">Lunch Price (<?php echo $estimate['lunch_vat_percentage']; ?>%)</p></th>
                <td><span>&euro; <?php echo $estimate['include_lunch_price']; ?></span></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Excluding Lunch VAT Amount</p></th>
                <td><span>&euro; <?php echo $estimate['lunch_vat_excluded_amount']; ?></span></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Lunch Vat Amount (<?php echo $estimate['lunch_vat_percentage']; ?>%)</p></th>
                <td><span>&euro; <?php echo $estimate['lunch_vat_amount']; ?></span></td>
              </tr>
              @endif

              @if($estimate['settlement_amount'])
              <tr>
                <th><p class="semibold-text">Settlement Amount : </p></th>
                <td><span>&euro; <?= $estimate['settlement_amount'] ?> </span></td>
              </tr>
              @endif

              <tr>
                <th><h3 style="margin-bottom:10px;margin-top:10px"><b>Total Price: </b></h3></th>
                <td><h3 style="margin-bottom:10px;margin-top:10px"><b>&euro; <?php echo $estimate['net_price']; ?></b></h3></td>
              </tr>
