      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
              ...
              <tr>
                ...
                <td width="60%" class="top-right-panel" style="text-align: right;">
                  <ul class="navigation">
                    ...
                    @if(isset($is_reverse_charge) && $is_reverse_charge)
                      <h1 class="mb0 gray-invoice-text">Consolidated Payment Form Reverse Charge</h1>
                    @else
                      <h1 class="mb0 gray-invoice-text">Consolidated Payment Form</h1>
                    @endif
                    </li>
                  </ul>
                  <p><b>Reference Number:</b> # <?php echo $invoice_numbers; ?></p>
              ...
              <tr>
                <td width="60%" class="logo top-right-panel" style="text-align: left;">
                  ...
                  <div class="invoice__company-contact">
                    <p><b>Email:</b><span class="ml-2"><?php echo $emails; ?></span></p>
                </td>
        ...
        <tr>
          <td valign="top" class="bg_white" style="">
            <table class="payment-table">
              <tr><td colspan="2"><br/><h3>Invoice Detail</h3></td></tr>
              <tr>
                <th><p class="semibold-text">Vat excluded amount : </p></th>
                <td><span>@currency_format($vat_excluded_amount)</span></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Vat amount(<?php echo $vat_percentage; ?>%) : </p></th>
                <td><span>@currency_format($vat_amount)</span></td>
              </tr>
              <tr>
                <th><p class="semibold-text">Total invoice amount : </p></th>
                <td><b><span>@currency_format($total_amount)</span></b></td>
              </tr>
              @if($settlement_amount)
              <tr>
                <th><p class="semibold-text">Settlement Amount : </p></th>
                <td><span>@currency_format($settlement_amount) </span></td>
              </tr>
              @endif
            </table>
        ...
        @if(count($product_details))
          <tr>
            <td valign="top" class="bg_white" style="">
              <table class="payment-table">
                <tr><td colspan="2"><br/><h3>Product Detail</h3></td></tr>
                  <tr>
                    <th><p class="semibold-text">Product name : </p></th>
                    <th><p class="semibold-text">Product price(vat%)  : </p></th>
                  </tr>
                  @foreach($product_details as $product)
                  <tr>
                    <td><?= $product['product_name'] ?></td>
                    <td>@currency_format($product['product_price'])(<?= $product['product_vat'] ?>%)</td>
                  </tr>
                  @endforeach
                  <tr>
                    <td><br/><h3>Grant total : </h3></td>
                    <td><b><span>@currency_format($grant_amount)</b></span></td>
                  </tr>
              </table>
            </td>
          </tr><!-- end tr -->
